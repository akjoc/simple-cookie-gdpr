        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="close" onclick="closeDisclaimerModal()" aria-label="Close">
                        ...
                        <div id="cookies_accordion">
                            <?php foreach ($cookies as $index => $cookie): ?>
                                <div class="card mb-2">
                                    <details>
                                        <summary>
                                            <div class="card-header" id="heading<?php echo esc_attr($index); ?>">
                                                <div class="mb-0 model-text-toggle">
                                                    <div class="w-100">
                                                        <span class="model-click-button collapsed">
                                                            <?php echo esc_html($cookie['name']); ?>
                                                        </span>
                                                    </div>
                                                    <div class="cookies_sec_tgl model-text-toggle">
                                                        <label class="toggle">
                                                            <input type="checkbox" <?php echo !empty($cookie['status']) ? 'checked' : ''; ?>>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" onclick="closeDisclaimerModal()"><?php echo esc_html($modal_close_button_text); ?></button>
